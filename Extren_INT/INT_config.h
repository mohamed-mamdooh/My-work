...
#define INT_u8INT_0_SENSE     INT_u8LOGCHNG
#define INT_u8INT_1_SENSE     INT_u8LOGCHNG

//MCUCR : INT2 sense control
//range: INIT_u8LOW --> FallingEdge , INIT_u8HIGH --> RisingEdge
#define INT_u8INT_2_SENSE      INT_u8HIGH


//GICR : ENABLE - DISSABLE EX_INT
// range : INIT_u8LOW --> DISABLE , INIT_u8HIGH --> ENABLE
#define INT_u8INT_0_EN    INT_u8LOW
