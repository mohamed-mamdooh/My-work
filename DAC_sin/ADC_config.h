...
//range REFS0=0 , REFS1=0 --> Aref , REFS0 =1,REFS1 =0 --> AVCC , REFS0 =1,REFS1 =1 -->internal
#define ADC_REFS1_INITVAL     ADC_LOW
#define ADC_REFS0_INITVAL     ADC_HIGH

//range : ADLAR =0 --> right shifted , ADLAR =1 --> LIFT shifted
...
#define ADC_ADPS2_INITVAL      ADC_LOW
#define ADC_ADPS1_INITVAL      ADC_LOW
#define ADC_ADPS0_INITVAL      ADC_LOW
